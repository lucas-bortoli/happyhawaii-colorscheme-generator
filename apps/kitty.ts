...
export async function modifyKittyConfig(
...
# dark gray
color8 ${palette.mainColor.saturate(-1).darken(0.50).hex()}
# white
color7 ${palette.mainColor.saturate(-1).lighten(0.50).hex()}
# light gray
color15 ${palette.mainColor.saturate(-1).darken(0.25).hex()}

foreground ${palette.mainColor.saturate(-1).lighten(0.50).hex()}
